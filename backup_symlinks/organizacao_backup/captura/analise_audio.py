#!/usr/bin/env python3
"""
Script para análise detalhada do conteúdo de áudio
"""
...
def analisar_audio_detalhado(caminho_entrada):
    """Analisar detalhadamente o conteúdo do áudio"""
    
    print(f"Análise detalhada do áudio: {caminho_entrada}")
    print("=" * 60)
    ...
    print(f"Taxa de bits: {audio_stream.bit_rate if audio_stream.bit_rate else 'Desconhecida'}")
...
def main(caminho_arquivo):
    ...
    analisar_audio_detalhado(caminho_arquivo)

if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Uso: python3 analise_audio.py <caminho_do_arquivo>")
        sys.exit(1)
